 ...
 * @brief Declaração da classe Model_implement (Motor da simulação).
 */

#ifndef MODEL_IMPLEMENT_HPP
#define MODEL_IMPLEMENT_HPP
 ...
 */
class Model_implement : public Model {
protected:
...
public:
  ...
  virtual ~Model_implement();

  /** @brief Construtor de cópia. */
  Model_implement(const Model_implement &other);

  /** @brief Operador de atribuição. */
  Model_implement &operator=(const Model_implement &other);
